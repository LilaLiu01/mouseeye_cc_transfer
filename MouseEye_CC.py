...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/seanliu/Documents/AMC_Lab/MouseEye/MouseEye_TunnelVision_Prolific_ContextualCueing_fromscratch/MouseEye_CC.py',
